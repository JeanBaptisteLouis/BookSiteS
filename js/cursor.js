...
(function($) {
  $.fn.zacursor = function(options) {
    ...
    return this.each(function(e) {
      ...
      $(this).css("cursor", "none");
      $(this).append(
        "<div id='za_cursor' style='position: fixed; z-index: 1400; pointer-events:none; overflow: visible;'><div style='position: absolute; top: 0px; left: 0px; transform: translate(-50%, -50%); -webkit-transform: translate(-50%, -50%); border-radius: 1000px; width: " +
          options.size1 +
          "; height: " +
          options.size1 +
          ";  max-width: " +
